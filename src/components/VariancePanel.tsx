...
import { compileMonitor } from '../engine/compile-variance';
import { BACKEND_LABEL, readReport, type Backend } from '../engine/compile';
import { fmt } from '../engine/format';
import { parseDoc, type Graph } from '../engine/parse';
import type { Registry } from '../engine/registry';
import { readMonitor, runMonitor, BASIS_WINDOW, MIN_OBSERVATIONS } from '../engine/variance';
import { HUE, type FixtureName, type Severity } from '../engine/vocab';
